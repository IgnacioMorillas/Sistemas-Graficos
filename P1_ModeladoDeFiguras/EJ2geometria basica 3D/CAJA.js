...
class CAJA extends THREE.Object3D {
  ...
  createGUI (gui,titleGui) {
    ...
    var folder2 = gui.addFolder ("Dimensiones Caja");
    ...
    folder2.add (this.guiControls, 'Dimension_X', 0.2, 3, 0.001).name ('Dimensión X : ');
    folder2.add (this.guiControls, 'Dimension_Y', 0.2, 3, 0.001).name ('Dimensión Y : ');
    folder2.add (this.guiControls, 'Dimension_Z', 0.2, 3, 0.001).name ('Dimensión Z : ');
  }
