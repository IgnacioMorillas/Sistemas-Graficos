...
class TORO extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.createGUI(gui,"Dimensiones Toro");
  ...
  createBase() {
    ...
    var cajaBase = new THREE.Mesh (new THREE.TorusGeometry (1,1,5,5), this.material);
  ...
  createGUI (gui,titleGui) {
    ...
    this.guiControls = new function () {
      this.RadioPrincipal=1;
      this.RadioTubo=1;
      this.ResolucionToro=5;
      this.ResolucionTubo=5;
    ...
    folder2.add (this.guiControls, 'RadioPrincipal', 1, 3, 0.001).name ('RadioPrincipal : ');
    folder2.add (this.guiControls, 'RadioTubo', 0.2, 2, 0.001).name ('RadioTubo : ');
    folder2.add (this.guiControls, 'ResolucionToro', 5, 15, 1).name ('ResolucionToro : ');
    folder2.add (this.guiControls, 'ResolucionTubo', 5, 15, 1).name ('ResolucionTubo : ');
  ...
  update () {
    ...
    this.RadioPrincipal=this.guiControls.RadioPrincipal;
    this.RadioTubo=this.guiControls.RadioTubo;
    this.ResolucionToro=this.guiControls.ResolucionToro;
    this.ResolucionTubo=this.guiControls.ResolucionTubo;
    //this.scale.set(this.RadioSuperior,this.RadioInferior,this.Altura,this.resolucion);
    this.remove(this.children[0]);
    var base = new THREE.Object3D();
    var cajaBase = new THREE.Mesh (new THREE.TorusGeometry (this.RadioPrincipal,this.RadioTubo,this.ResolucionToro,this.ResolucionTubo), this.material);
    base.add(cajaBase);
