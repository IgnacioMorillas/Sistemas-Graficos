...
class CONO extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.createGUI(gui,"Dimensiones Cono");
  ...
  createBase() {
    ...
    var cajaBase = new THREE.Mesh (new THREE.ConeGeometry (1,5,10), this.material);
  ...
  createGUI (gui,titleGui) {
    ...
    folder2.add (this.guiControls, 'Altura', 1, 5, 0.001).name ('Altura : ');
  ...
  update () {
    ...
    var base = new THREE.Object3D();
    var cajaBase = new THREE.Mesh (new THREE.ConeGeometry (this.Radio,this.Altura,this.resolucion), this.material);
    base.add(cajaBase);
