...
class CILINDRO extends THREE.Object3D {
  constructor(gui,titleGui) {
    ...
    this.createGUI(gui,"Dimensiones Cilindro");
  ...
  createBase() {
    ...
    var cajaBase = new THREE.Mesh (new THREE.CylinderGeometry (1,1,5,10), this.material);
  ...
  createGUI (gui,titleGui) {
    ...
    this.guiControls = new function () {
      this.RadioSuperior=1;
      this.RadioInferior=1;
      this.Altura=5;
      this.resolucion=10;
    ...
    folder2.add (this.guiControls, 'RadioSuperior', 0.2, 3, 0.001).name ('RadioSuperior : ');
    folder2.add (this.guiControls, 'RadioInferior', 0.2, 3, 0.001).name ('RadioInferior : ');
    folder2.add (this.guiControls, 'Altura', 0.5, 3, 0.001).name ('Altura : ');
    folder2.add (this.guiControls, 'resolucion', 5, 20, 1).name ('resolucion : ');
  ...
  update () {
    ...
    this.RadioSuperior=this.guiControls.RadioSuperior;
    this.RadioInferior=this.guiControls.RadioInferior;
    ...
    var base = new THREE.Object3D();
    var cajaBase = new THREE.Mesh (new THREE.CylinderGeometry (this.RadioSuperior,this.RadioInferior,this.Altura,this.resolucion), this.material);
    base.add(cajaBase);
