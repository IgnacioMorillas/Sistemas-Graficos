...
class MyScene extends THREE.Scene {
  ...
  constructor (myCanvas) {
    ...
    //AÑADIMOS CAJA
    this.add(this.constructor_partefigura(this.gui));
  }

  constructor_partefigura(gui){
    var partefigura = new THREE.Object3D();
    this.figura = new FIGURA(gui);
    //this.figura.position.set(-9,5,9);
    // Y unos ejes. Imprescindibles para orientarnos sobre dónde están las cosas
    this.axisfigura = new THREE.AxesHelper (3);
    ...
    partefigura.add (this.axisfigura);
    partefigura.add (this.figura);
    return partefigura;
  }/*
...
*/
  createCamera () {
    ...
    this.camera.position.set (15, 3, 15);
    // Y hacia dónde mira
